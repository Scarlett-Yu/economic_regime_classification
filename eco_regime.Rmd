...
Since the absolute value of some variable like CPI is much greater than else
In that case, before PCA, in addition to centering each variable,
we also multiply it times a constant to make its variance equal to 1,
i.e. we standardize each variable.
