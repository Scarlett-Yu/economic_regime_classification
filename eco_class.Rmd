...
After removing 2020, the data become more dispersed in the panel.
...
```{r echo=FALSE, fig.height=8, fig.width=8}
df.yearly2.2019 = df.yearly2[, !colnames(df.yearly2) %in% c("CPI YOY Index", "EHUPUS Index", "M2% YOY Index")]
