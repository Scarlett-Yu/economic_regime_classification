...
4. Developing and implementing a regime-based allocation policy doesn't require perfect forecasting skills, since anticipating the direction of regime change matters matters more than predicting the absolute rate of change in the 4 factors.
...
- 2020 (Covid-19 recession) is a new class of economic regime, the scale of which is unprecedented.
